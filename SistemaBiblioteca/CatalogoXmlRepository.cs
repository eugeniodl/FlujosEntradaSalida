...
public class CatalogoXmlRepository : ICatalogoRepository
{
    ...
    {
        XmlSerializer serializer = new(typeof(CatalogoLibros));

        using FileStream fs = new(_rutaArchivo, FileMode.Create);
    ...
    public CatalogoLibros Obtener()
    {
        ...
        using FileStream fs = new(_rutaArchivo, FileMode.Open);
