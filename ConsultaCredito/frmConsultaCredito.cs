...
namespace ConsultaCredito
{
    public partial class frmConsultaCredito : Form
    {
        ...
        private StreamReader archivoReader; // lee los datos del archivo de texto

        // nombre del archivo que almacena los saldos con rédito, débito o cero
        ...
        {
            // convierte el emisor explícitamente a un objeto de tipo de Button
            Button emisorButon = (Button)sender;

            // obtiene el texto del botón en el que se hizo clic, y que almacena el tipo
            // de la cuenta
            string tipoCuenta = emisorButon.Text;
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    registro = new Registro(Convert.ToInt32(camposEntrada[0]), camposEntrada[1],
